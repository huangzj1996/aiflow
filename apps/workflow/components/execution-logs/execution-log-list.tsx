...
import { ExecutionLogInfo, ExecutionLogQuery } from '@/lib/types/execution'
...
const ExecutionLogList = ({ appId }: ExecutionLogListProps) => {
    ...
    }, [appId, getDateRange, page, status, search])
