...
import { DetailsTab } from '../test-run/tabs/details-tab'
import { ResultTab } from '../test-run/tabs/result-tab'
import { TraceTab } from '../test-run/tabs/trace-tab'
...
export function ExecutionDetailPanel({ open, onOpenChange, appId, executionId, nodes }: ExecutionDetailPanelProps) {
    ...
    const fetchDetail = useCallback(async () => {
        ...
        try {
            const response = await fetch(`/api/apps/${appId}/workflow/executions/${executionId}`, { method: 'GET' })
