...
export function VariableTag({ variable, removable, onRemove, className }: VariableTagProps) {
    ...
    return (
        <span
            ...
            style={{ backgroundColor: 'var(--primary-50, #eff6ff)', color: 'var(--primary-700, #1d4ed8)' }}
        >
...
export function VariableRenderer(props: VariableRendererProps) {
    const { value, availableOutputs, className } = props
