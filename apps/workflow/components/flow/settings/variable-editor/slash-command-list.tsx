...
import { AvailableNodeOutput } from '../node-outputs'
...
export const SlashCommandList = ({ items, command, ref }: SlashCommandListProps) => {
                    ...
                    return (
                        <div key={nodeOutput.nodeId}>
                            ...
                            <div className="flex items-center gap-2 px-3 py-1.5 bg-muted/40 border-b">
                                <span className={`w-5 h-5 rounded flex items-center justify-center text-white shrink-0 ${bgColor}`}>
