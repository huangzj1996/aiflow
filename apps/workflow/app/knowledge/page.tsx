...
import { KnowledgeBase, knowledgeService } from '@/lib/services/knowledge-service'
// 分页配置
        ...
        <div className="px-12 py-6">
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5' : 'space-y-3'}>
                ...
                {loading
                    ...
                    : knowledgeBases.map(kb => <KnowledgeCard knowledge={kb} key={kb.id} onDelete={handleDeleted} />)}
            </div>
