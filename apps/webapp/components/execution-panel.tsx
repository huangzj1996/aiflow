...
import type { ExecutionState, NodeExecution, NodeStatus } from '@/lib/type'
        ...
        <div className={cn('overflow-hidden rounded-xl border', panelColor)}>
            ...
            {execution.status === 'success' && execution.outputs && (
                <div className="border-t bg-white/80 p-4">
                    ...
                    <pre className="overflow-x-auto break-words whitespace-pre-wrap rounded-lg bg-muted/50 p-3 text-xs">
