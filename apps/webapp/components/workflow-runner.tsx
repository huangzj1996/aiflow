...
import type { ExecutionState, InputField, NodeExecution, SSEEvent } from '@/lib/type'
...
export function WorkflowRunner({ appId, appName, appIcon, inputs }: WorkflowRunnerProps) {
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex flex-col w-full flex-shrink bg-gradient-to-br from-violet-50 to-blue-50 p-8">
